//all the request comes from the Customer side follow this controller
...
public class CateringController {
	...
	public String saveBooking(@RequestParam("b_custName") String b_custName, 
		@RequestParam("b_contact") Long b_contact,
		...
		@RequestParam("bpeoples") Long bpeoples, 
		@RequestParam("session") String session, Model m) 
	{
	...
	public String FinalBooking(@RequestParam("b_id") Long b_id, 
			@RequestParam("foName") String foName,
			@RequestParam("qauntity") Long qauntity, Model m) 
	{
		// sending the data in databased 
		...
		// send b_id to booking success page.
